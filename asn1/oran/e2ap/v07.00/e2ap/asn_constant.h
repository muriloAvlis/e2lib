...
#define maxofRICsubscriptions (2147483648)
...
#define min_val_RICassistanceSN (0)
#define max_val_RICassistanceSN (65535)
#define min_val_RICassistanceUpdateNumber (0)
#define max_val_RICassistanceUpdateNumber (65535)

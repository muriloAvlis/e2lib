...
typedef enum CauseRICrequest {
	 ...
	 */
	CauseRICrequest_ric_subscription_end_time_expired	= 14,
	CauseRICrequest_ric_subscription_end_time_invalid	= 15,
	CauseRICrequest_duplicate_ric_request_id	= 16,
	CauseRICrequest_eventTriggerNotSupported	= 17,
	CauseRICrequest_requested_information_unavailable	= 18,
	CauseRICrequest_invalid_information_request	= 19
} e_CauseRICrequest;
...
jer_type_encoder_f CauseRICrequest_encode_jer;

...
#define ProcedureCode_id_RICsubscriptionModification	((ProcedureCode_t)14)
#define ProcedureCode_id_RICsubscriptionModificationRequired	((ProcedureCode_t)15)
#define ProcedureCode_id_RICquery	((ProcedureCode_t)16)
#define ProcedureCode_id_RICsubscriptionAudit	((ProcedureCode_t)17)
#define ProcedureCode_id_RICserviceLoadStatus	((ProcedureCode_t)18)
#define ProcedureCode_id_RICserviceLoadUpdate	((ProcedureCode_t)19)
#define ProcedureCode_id_RICsubscriptionStateControl	((ProcedureCode_t)20)
#define ProcedureCode_id_RICassistance	((ProcedureCode_t)21)
#define ProcedureCode_id_RICassistanceIndication	((ProcedureCode_t)22)
#define ProcedureCode_id_RICassistanceHalt	((ProcedureCode_t)23)

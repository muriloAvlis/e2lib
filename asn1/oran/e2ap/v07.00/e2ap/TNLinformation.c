...
static asn_jer_constraints_t asn_JER_memb_tnlAddress_constr_2 CC_NOTUSED = {
	-1};
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
static asn_jer_constraints_t asn_JER_memb_tnlPort_constr_3 CC_NOTUSED = {
	16};
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
asn_TYPE_member_t asn_MBR_TNLinformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TNLinformation, tnlAddress),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_tnlAddress_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_tnlAddress_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			&asn_JER_memb_tnlAddress_constr_2,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	{ ATF_POINTER, 1, offsetof(struct TNLinformation, tnlPort),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_tnlPort_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_tnlPort_constr_3,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			&asn_JER_memb_tnlPort_constr_3,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */

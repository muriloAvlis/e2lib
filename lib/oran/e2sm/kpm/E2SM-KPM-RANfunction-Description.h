...
struct RIC_IntegratedReportStyle_Item;
...
typedef struct E2SM_KPM_RANfunction_Description {
	 ...
	 */
	struct E2SM_KPM_RANfunction_Description__ric_IntegratedReportStyle_List {
		A_SEQUENCE_OF(struct RIC_IntegratedReportStyle_Item) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ric_IntegratedReportStyle_List;

...
typedef enum E2SM_KPM_IndicationMessage__indicationMessage_formats_PR {
	...
	E2SM_KPM_IndicationMessage__indicationMessage_formats_PR_indicationMessage_Format255
...
struct E2SM_KPM_IndicationMessage_Format255;
...
typedef struct E2SM_KPM_IndicationMessage {
	struct E2SM_KPM_IndicationMessage__indicationMessage_formats {
		...
		union E2SM_KPM_IndicationMessage__indicationMessage_formats_u {
			...
			struct E2SM_KPM_IndicationMessage_Format255	*indicationMessage_Format255;
		} choice;
...
extern asn_SEQUENCE_specifics_t asn_SPC_E2SM_KPM_IndicationMessage_specs_1;
extern asn_TYPE_member_t asn_MBR_E2SM_KPM_IndicationMessage_1[2];

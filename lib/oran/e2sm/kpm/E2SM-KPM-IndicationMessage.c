...
static asn_TYPE_member_t asn_MBR_indicationMessage_formats_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct E2SM_KPM_IndicationMessage__indicationMessage_formats, choice.indicationMessage_Format255),
...
static const asn_TYPE_tag2member_t asn_MAP_indicationMessage_formats_tag2el_2[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* indicationMessage-Format255 */
};
...
asn_TYPE_member_t asn_MBR_E2SM_KPM_IndicationMessage_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct E2SM_KPM_IndicationMessage, jobID),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_JobID,
		0,
...
static const int asn_MAP_E2SM_KPM_IndicationMessage_oms_1[] = { 1 };
...
static const asn_TYPE_tag2member_t asn_MAP_E2SM_KPM_IndicationMessage_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* jobID */
};
asn_SEQUENCE_specifics_t asn_SPC_E2SM_KPM_IndicationMessage_specs_1 = {
	...
	asn_MAP_E2SM_KPM_IndicationMessage_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */

...
asn_TYPE_member_t asn_MBR_UEID_NG_ENB_DU_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct UEID_NG_ENB_DU, cell_RNTI),
...
static const int asn_MAP_UEID_NG_ENB_DU_oms_1[] = { 1 };
...
static const asn_TYPE_tag2member_t asn_MAP_UEID_NG_ENB_DU_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cell-RNTI */
};
asn_SEQUENCE_specifics_t asn_SPC_UEID_NG_ENB_DU_specs_1 = {
	...
	asn_MAP_UEID_NG_ENB_DU_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */

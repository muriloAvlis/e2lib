...
asn_TYPE_descriptor_t asn_DEF_ric_ControlAction_List_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_ric_ControlAction_List_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_ran_ControlOutcomeParameters_List_10 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_ran_ControlOutcomeParameters_List_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_RANFunctionDefinition_Control_Item_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RANFunctionDefinition_Control_Item, ric_ControlAction_List),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_ric_ControlAction_List_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_ric_ControlAction_List_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_ric_ControlAction_List_constraint_1
		},
		0, 0, /* No default value */
		"ric-ControlAction-List"
		},
	...
	{ ATF_POINTER, 2, offsetof(struct RANFunctionDefinition_Control_Item, ran_ControlOutcomeParameters_List),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_ran_ControlOutcomeParameters_List_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_ran_ControlOutcomeParameters_List_constr_10,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_ran_ControlOutcomeParameters_List_constraint_1
		},
		0, 0, /* No default value */
		"ran-ControlOutcomeParameters-List"
		},
	{ ATF_POINTER, 1, offsetof(struct RANFunctionDefinition_Control_Item, listOfAdditionalSupportedFormats),
...
static const int asn_MAP_RANFunctionDefinition_Control_Item_oms_1[] = { 2, 5, 7, 8 };
...
static const asn_TYPE_tag2member_t asn_MAP_RANFunctionDefinition_Control_Item_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 } /* listOfAdditionalSupportedFormats */
};

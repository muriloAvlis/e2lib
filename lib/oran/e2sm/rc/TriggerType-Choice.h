...
typedef enum TriggerType_Choice_PR {
	...
	TriggerType_Choice_PR_triggerType_Choice_UEcontext,
	TriggerType_Choice_PR_triggerType_Choice_L2MACschChg
...
struct TriggerType_Choice_UEcontext;
struct TriggerType_Choice_L2MACschChg;
...
typedef struct TriggerType_Choice {
	...
	union TriggerType_Choice_u {
		 ...
		 */
		struct TriggerType_Choice_UEcontext	*triggerType_Choice_UEcontext;
		struct TriggerType_Choice_L2MACschChg	*triggerType_Choice_L2MACschChg;
	} choice;
...
extern asn_TYPE_member_t asn_MBR_TriggerType_Choice_1[5];

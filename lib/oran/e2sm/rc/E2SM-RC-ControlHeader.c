...
static asn_TYPE_member_t asn_MBR_ric_controlHeader_formats_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct E2SM_RC_ControlHeader__ric_controlHeader_formats, choice.controlHeader_Format4),
...
static const asn_TYPE_tag2member_t asn_MAP_ric_controlHeader_formats_tag2el_2[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* controlHeader-Format4 */
};

...
typedef struct E2SM_RC_IndicationMessage_Format3_Item {
	...
	struct NeighbourRelation_Info	*neighbourRelation_Table;	/* OPTIONAL */
	/*
	 * This type is extensible,
	 * possible extensions are below.
	 */
	OCTET_STRING_t	*mib;	/* OPTIONAL */
	struct ServingCellConfigCommon	*servingCellConfigCommon;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_E2SM_RC_IndicationMessage_Format3_Item_1[6];

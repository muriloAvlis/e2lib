...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_ueGroup_ControlAction_Supported_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_ueGroup_ControlAction_Supported_constr_7 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_ran_ControlActionParameters_List_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_ran_ControlActionParameters_List_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_ran_ControlActionParameters_List_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static const asn_INTEGER_enum_map_t asn_MAP_ueGroup_ControlAction_Supported_value2enum_7[] = {
	{ 0,	4,	"true" },
	{ 1,	5,	"false" }
	/* This list is extensible */
};
static const unsigned int asn_MAP_ueGroup_ControlAction_Supported_enum2value_7[] = {
	1,	/* false(1) */
	0	/* true(0) */
	/* This list is extensible */
};
static const asn_INTEGER_specifics_t asn_SPC_ueGroup_ControlAction_Supported_specs_7 = {
	asn_MAP_ueGroup_ControlAction_Supported_value2enum_7,	/* "tag" => N; sorted by tag */
	asn_MAP_ueGroup_ControlAction_Supported_enum2value_7,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_ueGroup_ControlAction_Supported_tags_7[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ueGroup_ControlAction_Supported_7 = {
	"ueGroup-ControlAction-Supported",
	"ueGroup-ControlAction-Supported",
	&asn_OP_NativeEnumerated,
	asn_DEF_ueGroup_ControlAction_Supported_tags_7,
	sizeof(asn_DEF_ueGroup_ControlAction_Supported_tags_7)
		/sizeof(asn_DEF_ueGroup_ControlAction_Supported_tags_7[0]) - 1, /* 1 */
	asn_DEF_ueGroup_ControlAction_Supported_tags_7,	/* Same as above */
	sizeof(asn_DEF_ueGroup_ControlAction_Supported_tags_7)
		/sizeof(asn_DEF_ueGroup_ControlAction_Supported_tags_7[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_ueGroup_ControlAction_Supported_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_ueGroup_ControlAction_Supported_constr_7,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	&asn_SPC_ueGroup_ControlAction_Supported_specs_7	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_RANFunctionDefinition_Control_Action_Item_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RANFunctionDefinition_Control_Action_Item, ran_ControlActionParameters_List),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_ran_ControlActionParameters_List_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_ran_ControlActionParameters_List_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_ran_ControlActionParameters_List_constraint_1
		},
		0, 0, /* No default value */
		"ran-ControlActionParameters-List"
		},
	{ ATF_POINTER, 1, offsetof(struct RANFunctionDefinition_Control_Action_Item, ueGroup_ControlAction_Supported),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ueGroup_ControlAction_Supported_7,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_RANFunctionDefinition_Control_Action_Item_oms_1[] = { 2, 3 };
...
static const asn_TYPE_tag2member_t asn_MAP_RANFunctionDefinition_Control_Action_Item_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* ueGroup-ControlAction-Supported */
};

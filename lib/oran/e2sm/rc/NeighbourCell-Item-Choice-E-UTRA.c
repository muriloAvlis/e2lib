...
#include "NeighbourCell-Item-Choice-E-UTRA.h"
...
asn_TYPE_descriptor_t asn_DEF_x2_Xn_established_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_x2_Xn_established_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_x2_Xn_established_constr_6,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
...
asn_TYPE_descriptor_t asn_DEF_hO_validated_10 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_hO_validated_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_hO_validated_constr_10,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
asn_TYPE_member_t asn_MBR_NeighbourCell_Item_Choice_E_UTRA_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourCell_Item_Choice_E_UTRA, eUTRA_CGI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourCell_Item_Choice_E_UTRA, eUTRA_PCI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourCell_Item_Choice_E_UTRA, eUTRA_ARFCN),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourCell_Item_Choice_E_UTRA, eUTRA_TAC),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourCell_Item_Choice_E_UTRA, x2_Xn_established),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourCell_Item_Choice_E_UTRA, hO_validated),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighbourCell_Item_Choice_E_UTRA, version),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_version_constr_14,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_version_constr_14,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
static const ber_tlv_tag_t asn_DEF_NeighbourCell_Item_Choice_E_UTRA_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NeighbourCell_Item_Choice_E_UTRA_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_NeighbourCell_Item_Choice_E_UTRA_specs_1 = {
	sizeof(struct NeighbourCell_Item_Choice_E_UTRA),
	offsetof(struct NeighbourCell_Item_Choice_E_UTRA, _asn_ctx),
	asn_MAP_NeighbourCell_Item_Choice_E_UTRA_tag2el_1,
	7,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	7,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_NeighbourCell_Item_Choice_E_UTRA = {
	"NeighbourCell-Item-Choice-E-UTRA",
	"NeighbourCell-Item-Choice-E-UTRA",
	&asn_OP_SEQUENCE,
	asn_DEF_NeighbourCell_Item_Choice_E_UTRA_tags_1,
	sizeof(asn_DEF_NeighbourCell_Item_Choice_E_UTRA_tags_1)
		/sizeof(asn_DEF_NeighbourCell_Item_Choice_E_UTRA_tags_1[0]), /* 1 */
	asn_DEF_NeighbourCell_Item_Choice_E_UTRA_tags_1,	/* Same as above */
	sizeof(asn_DEF_NeighbourCell_Item_Choice_E_UTRA_tags_1)
		/sizeof(asn_DEF_NeighbourCell_Item_Choice_E_UTRA_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_NeighbourCell_Item_Choice_E_UTRA_1,
	7,	/* Elements count */
	&asn_SPC_NeighbourCell_Item_Choice_E_UTRA_specs_1	/* Additional specs */
};

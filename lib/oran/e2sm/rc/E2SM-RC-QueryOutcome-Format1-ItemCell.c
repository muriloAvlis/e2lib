...
asn_TYPE_member_t asn_MBR_E2SM_RC_QueryOutcome_Format1_ItemCell_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct E2SM_RC_QueryOutcome_Format1_ItemCell, neighbourRelation_Table),
	...
	{ ATF_POINTER, 1, offsetof(struct E2SM_RC_QueryOutcome_Format1_ItemCell, servingCellConfigCommon),
...
static const int asn_MAP_E2SM_RC_QueryOutcome_Format1_ItemCell_oms_1[] = { 2, 3 };
...
static const asn_TYPE_tag2member_t asn_MAP_E2SM_RC_QueryOutcome_Format1_ItemCell_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* neighbourRelation-Table */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* servingCellConfigCommon */
};

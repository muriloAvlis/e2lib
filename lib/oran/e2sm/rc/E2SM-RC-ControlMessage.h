...
typedef enum E2SM_RC_ControlMessage__ric_controlMessage_formats_PR {
	...
	E2SM_RC_ControlMessage__ric_controlMessage_formats_PR_controlMessage_Format4,
	E2SM_RC_ControlMessage__ric_controlMessage_formats_PR_controlMessage_Format5
...
struct E2SM_RC_ControlMessage_Format4;
...
typedef struct E2SM_RC_ControlMessage {
	struct E2SM_RC_ControlMessage__ric_controlMessage_formats {
		...
		union E2SM_RC_ControlMessage__ric_controlMessage_formats_u {
			...
			struct E2SM_RC_ControlMessage_Format4	*controlMessage_Format4;
			E2SM_RC_ControlMessage_Format5_t	 controlMessage_Format5;
		} choice;

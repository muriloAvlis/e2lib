...
struct ListOfAdditionalSupportedFormats;
...
typedef struct RANFunctionDefinition_Control_Item {
	 ...
	 */
	struct ListOfAdditionalSupportedFormats	*listOfAdditionalSupportedFormats;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_RANFunctionDefinition_Control_Item_1[9];
